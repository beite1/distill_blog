...
ggplotly(G, tooltip = c("Subject", "Percentage")) %>% layout(legend = list(orientation = "h", x = 0.0, y = -0.0)) 
...
SubjectData <- as.data.frame(matrix(c(subjectNameM, PercM), ncol = 2, nrow = 7))
colnames(SubjectData) <- c("Subject", "Percentage")
SubjectData$X <- 1
